    ...
    <main className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      >
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(139,92,246,0.18),transparent_45%),radial-gradient(circle_at_80%_25%,rgba(99,102,241,0.14),transparent_42%),radial-gradient(circle_at_50%_80%,rgba(59,130,246,0.12),transparent_50%)]" />
        </div>
