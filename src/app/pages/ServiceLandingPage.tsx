...
export const pageConfigs: Record<ServiceType, Omit<ServiceLandingPageProps, 'service' | 'theme'>> = {
  ...
  consult: {
    seo: {
      title: 'Консультация для таргетологов: оффер, клиенты и продажи',
      description: 'Личный разбор для таргетологов: один главный запрос, работа с профилем, кейсами или перепиской и план действий на 30 дней.',
      url: '/consult',
    },
    hero: {
    ...
    services: {
      ...
      description: 'Выбираем одну основную задачу и разбираем её глубоко. Попытка охватить всё за один созвон даст только поверхностные советы.',
      cards: [
        {
          icon: Users,
          title: 'Оффер и позиционирование',
          description: 'Определяем, кому и какой результат вы продаёте. Убираем общие формулировки и собираем один понятный оффер.',
          features: ['Ниша', 'Клиент', 'Результат', 'Оффер'],
          gradient: 'from-primary to-accent',
        },
        {
          icon: Briefcase,
          title: 'Портфолио и кейсы',
          description: 'Проверяем, понятно ли из профиля и кейсов, какую задачу вы решаете, что сделали и чем подтверждён результат.',
          features: ['Профиль', 'Кейсы', 'Доказательства', 'Пакеты'],
          gradient: 'from-accent to-secondary',
        },
        {
          icon: Target,
          title: 'Поиск клиентов',
          description: 'Выбираем один-два подходящих канала и формулируем первые сообщения без спама и шаблонных заходов.',
          features: ['Outreach', 'Контент', 'Партнёрства', 'Рекомендации'],
          gradient: 'from-secondary to-primary',
        },
        {
          icon: TrendingUp,
          title: 'Переговоры и продажа услуг',
          description: 'Разбираем переписку или созвон: какие вопросы задать, как определить объём работ, назвать цену и договориться о следующем шаге.',
          features: ['Бриф', 'Созвон', 'Цена', 'Следующий шаг'],
          gradient: 'from-primary via-accent to-secondary',
        },
      ],
      detailed: {
        ...
        sections: [
          {
            title: '1. ДО СОЗВОНА',
            icon: Target,
            text: 'Вы присылаете ссылку на профиль или портфолио, один главный вопрос и материал, на котором видна проблема: кейс, предложение или переписку.\n\nТак созвон начинается с вашей реальной ситуации, а не с долгого сбора вводных.',
          },
          {
            title: '2. НАХОДИМ УЗКОЕ МЕСТО',
            icon: Briefcase,
            text: 'Смотрим не на «рост вообще», а на конкретный этап: оффер, доверие, поиск клиентов или переговоры с заказчиком.\n\nОтделяем главную причину от второстепенных проблем и выбираем, что реально можно исправить за одну встречу.',
          },
          {
            title: '3. ПРАВИМ НА ПРИМЕРАХ',
            icon: Users,
            text: 'Переформулируем оффер, структуру кейса, первое сообщение или аргументацию цены прямо на ваших материалах.\n\nВы уходите не с набором общих советов, а с конкретными правками, которые можно применить после созвона.',
          },
          {
            title: '4. СЛЕДУЮЩИЕ ШАГИ',
            icon: TrendingUp,
            text: 'В конце определяем приоритеты на 30 дней: что изменить, что проверить и по каким признакам оценивать прогресс.\n\nПлан остаётся реалистичным по объёму и привязанным к одному главному запросу.',
          },
        ],
      },
    },
    cases: {
      ...
      description: 'Это рабочая встреча, а не курс и не длительное наставничество. Здесь не будет готовой базы клиентов или гарантии дохода.',
      items: [
        {
        ...
        {
          title: 'Кейсы не объясняют ценность',
          category: 'Портфолио',
          description: 'В кейсах много действий и скриншотов, но не видно задачи, логики решений и доказательств результата.',
          image: CASE_IMAGES.concierge,
          stats: [
            { label: 'Материал', value: 'Кейс' },
            { label: 'Фокус', value: 'Логика' },
            { label: 'Итог', value: 'Структура' },
          ],
        },
        {
          title: 'Клиенты приходят случайно',
          category: 'Поиск клиентов',
          description: 'Нет регулярного канала новых диалогов, а первые сообщения звучат шаблонно или не доходят до созвона.',
          image: CASE_IMAGES.ecommerce,
          stats: [
            { label: 'Каналы', value: '1–2' },
            { label: 'Старт', value: 'Сообщение' },
            { label: 'Итог', value: 'План' },
          ],
        },
        {
    ...
    contact: {
      ...
      bullets: [
        ...
        'Пример переписки, если вопрос о продажах',
      ],
    },
  },
};
