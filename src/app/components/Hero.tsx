...
const defaultHeroContent: HeroContent = {
  ...
  titleAccent: 'через Google Ads & Meta Ads',
  paragraphs: [
...
const LeftContent = memo(({ onScrollToContact, onScrollToCases, inView, content }: LeftContentProps) => (
  ...
  >
    ...
    <h1 className="max-w-2xl text-balance text-[clamp(1.65rem,7.2vw,2.35rem)] lg:text-[42px] xl:text-[46px] font-semibold md:font-bold leading-[1.12] md:leading-[1.08] tracking-[-0.022em] md:tracking-[-0.03em]">
