...
export const defaultHeroContent: HeroContent = {
  badge: 'Таргетолог Meta Ads · Google Ads',
  titlePrefix: 'Увеличу поток клиентов',
  titleAccent: 'через Google Ads и Meta Ads',
  paragraphs: [
    'Настраиваю рекламу в Instagram, Facebook и Google, которая приводит первые заявки уже в период теста и масштабируется в прибыль — с аналитикой, по которой видно, сколько стоит заявка и клиент.',
