...
function renderStaticPages(baseHtml) {
  const staticPages = [
    ...
    },
    {
      ...
      lead: 'Главная структура Whale Wzrd с услугами, кейсами, отзывами и заявкой на аудит рекламы.',
    },
    {
      route: '/google-ads',
      ...
      lead: 'Главная структура Whale Wzrd с услугами, кейсами, отзывами и заявкой на аудит кампаний.',
    },
    {
      route: '/consult',
